...
// Simulated API fetch for mastering beginner English
const fetchMasteringLessons = async () => [
  // Greetings
  {
    type: 'choice',
  ...
  {
    type: 'choice',
    question: "Which is a polite way to ask for water?",
    options: [
      "Give me water.",
      "Water, now!",
  ...
  {
    type: 'choice',
    question: "How do you ask someone how they feel?",
    options: [
      "How are you?",
      "Where are you?",
      "What is your name?",
  ...
  {
    type: 'choice',
    question: "What do you need to board a plane?",
    options: [
      "Boarding pass",
      "Passport",
      "Ticket",
  ...
  {
    type: 'match',
    question: "Match the greetings to the correct responses",
    pairs: [
      { left: "Good morning", right: "Good morning!" },
      { left: "How are you?", right: "I'm fine, thank you." },
      { left: "See you later", right: "Bye!" },
    ],
    panda: "https://cdn.pixabay.com/photo/2017/01/31/13/14/animal-2028258_1280.png",
  },
  // Matching food
  {
    type: 'match',
    question: "Match the food to its category",
    pairs: [
      { left: "Apple", right: "Fruit" },
      { left: "Chicken", right: "Meat" },
      { left: "Rice", right: "Grain" },
    ],
    panda: "https://cdn.pixabay.com/photo/2017/01/31/13/14/animal-2028258_1280.png",
  },
  // Polite refusal
  {
    type: 'choice',
    question: "How do you politely refuse an offer?",
    options: [
      "No, I don't want it.",
    ...
    answer: "No thanks, but I appreciate it.",
    panda: "https://cdn.pixabay.com/photo/2017/01/31/13/14/animal-2028258_1280.png",
  },
  // Travel phrase
  {
    type: 'choice',
    question: "Which phrase would you use to ask for directions?",
    options: [
    ...
    answer: "Where is the nearest bus stop?",
    panda: "https://cdn.pixabay.com/photo/2017/01/31/13/14/animal-2028258_1280.png",
  },
  // Matching travel
  {
    type: 'match',
    question: "Match the travel words to their meanings",
    pairs: [
      { left: "Passport", right: "Travel document" },
      { left: "Ticket", right: "Proof of purchase" },
      { left: "Luggage", right: "Bags and suitcases" },
    ],
    panda: "https://cdn.pixabay.com/photo/2017/01/31/13/14/animal-2028258_1280.png",
  },
  // More lessons for mastery
  {
    type: 'choice',
  ...
  {
    type: 'choice',
    question: "Which is a polite way to greet someone?",
    options: [
      "Hey you!",
      "What's up?",
  ...
  {
    type: 'match',
    question: "Match the polite phrases",
    pairs: [
      { left: "Thank you", right: "You're welcome" },
      { left: "Excuse me", right: "Yes?" },
      { left: "Please", right: "Could you..." },
    ],
    panda: "https://cdn.pixabay.com/photo/2017/01/31/13/14/animal-2028258_1280.png",
  },
];
...
const MasteringBeginnerPage = () => {
  ...
  useEffect(() => {
    (async () => {
      const data = await fetchMasteringLessons();
      setLessons(data);
    })();
  }, []);

  useEffect(() => {
    // Reset match state when lesson changes
  ...
  const handleModalContinue = (goIntermediate: boolean) => {
    setModalVisible(false);
    if (goIntermediate) {
      // Specify your intermediate route here
      router.replace('../(root)/(tabs)/englishPages/intermediate/englishintermediateHomepage');
    } else {
      ...
      <View style={styles.pandaContainer}>
        ...
        <View style={styles.speechBubble}>
          <Text style={styles.speechText}>
            {showCongrats
              ? "🎉 Amazing! You've completed all beginner lessons. Would you like to continue to the intermediate level?"
              : lesson.type === 'choice'
                ? "Let's master beginner English! Choose the correct answer below."
                : "Match the words or phrases by tapping one from each side."}
          </Text>
        </View>
      </View>
        ...
        <View style={styles.modalOverlay}>
          <View style={styles.modalBox}>
            ...
            <Text style={styles.congratsSubText}>
              You have mastered all beginner lessons and earned {xp} XP!
            </Text>
            <TouchableOpacity
              style={styles.continueBtn}
              onPress={() => handleModalContinue(true)}
              activeOpacity={0.85}
            >
              <Text style={styles.continueBtnText}>Continue to Intermediate</Text>
            </TouchableOpacity>
            <TouchableOpacity
              style={[styles.continueBtn, { backgroundColor: '#ccc', marginTop: 10 }]}
              onPress={() => handleModalContinue(false)}
              activeOpacity={0.85}
            >
              <Text style={[styles.continueBtnText, { color: '#7f6edb' }]}>Back to Home</Text>
            </TouchableOpacity>
          </View>
        </View>
      </Modal>
...
export default MasteringBeginnerPage;
