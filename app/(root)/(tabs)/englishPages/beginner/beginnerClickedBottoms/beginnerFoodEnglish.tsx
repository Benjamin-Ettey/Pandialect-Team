...
// Simulated API fetch for food lessons
const fetchFoodLessons = async () => [
  {
    type: 'choice',
  ...
  {
    type: 'choice',
    question: "Which is a common breakfast food?",
    options: [
      "Pizza",
      "Cereal",
      "Soup",
...
const beginnerFoodEnglish = () => {
  ...
  useEffect(() => {
    (async () => {
      const data = await fetchFoodLessons();
      setLessons(data);
    })();
  }, []);
      ...
      <View style={styles.pandaContainer}>
        ...
        <View style={styles.speechBubble}>
          <Text style={styles.speechText}>
            {showCongrats
              ? "🎉 Great job! You've completed the food lesson. Click continue to move on!"
              : lesson.type === 'choice'
                ? "Hi! Let's learn about food in English. Choose the correct answer below!"
                : "Match the food to its category by tapping one from each side."}
          </Text>
        </View>
      </View>
        ...
        <View style={styles.modalOverlay}>
          <View style={styles.modalBox}>
            ...
            <Text style={styles.congratsSubText}>
              You have mastered the food lesson and earned {xp} XP!
            </Text>
            <TouchableOpacity
...
export default beginnerFoodEnglish;
