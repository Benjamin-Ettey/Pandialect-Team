...
// Simulated API fetch for travel lessons
const fetchTravelLessons = async () => [
  {
    type: 'choice',
    ...
    answer: "Where is the nearest train station?",
    panda: "https://cdn.pixabay.com/photo/2017/01/31/13/14/animal-2028258_1280.png",
  },
  {
    type: 'choice',
    question: "Which is a polite way to ask for help while traveling?",
    options: [
      "Help me now!",
  ...
  {
    type: 'choice',
    question: "Which of these is NOT related to travel?",
    options: [
      "Boarding pass",
      "Suitcase",
      "Airplane",
...
const beginnerTravelsEnglish = () => {
  ...
  useEffect(() => {
    (async () => {
      const data = await fetchTravelLessons();
      setLessons(data);
    })();
  }, []);
      ...
      <View style={styles.pandaContainer}>
        ...
        <View style={styles.speechBubble}>
          <Text style={styles.speechText}>
            {showCongrats
              ? "🎉 Great job! You've completed the travel lesson. Click continue to move on!"
              : lesson.type === 'choice'
                ? "Hi! Let's learn about travel in English. Choose the correct answer below!"
                : "Match the travel words to their meanings by tapping one from each side."}
          </Text>
        </View>
      </View>
        ...
        <View style={styles.modalOverlay}>
          <View style={styles.modalBox}>
            ...
            <Text style={styles.congratsSubText}>
              You have mastered the travel lesson and earned {xp} XP!
            </Text>
            <TouchableOpacity
...
export default beginnerTravelsEnglish;
