...
// Simulated API fetch for polite English lessons
const fetchPoliteLessons = async () => [
  {
    type: 'choice',
    question: "How do you politely ask for help?",
    options: [
      "Give me that.",
  ...
  {
    type: 'choice',
    question: "Which is the polite way to greet someone?",
    options: [
      "Hey you!",
      "What's up?",
...
const beginnerPoliteEnglish = () => {
  ...
  useEffect(() => {
    (async () => {
      const data = await fetchPoliteLessons();
      setLessons(data);
    })();
  }, []);
      ...
      <View style={styles.pandaContainer}>
        ...
        <View style={styles.speechBubble}>
          <Text style={styles.speechText}>
            {showCongrats
              ? "🎉 Great job! You've completed polite English. Click continue to move on!"
              : lesson.type === 'choice'
                ? "Hi! Let's learn to be polite in English. Choose the correct answer below!"
                : "Match the polite phrases by tapping one from each side."}
          </Text>
        </View>
      </View>
        ...
        <View style={styles.modalOverlay}>
          <View style={styles.modalBox}>
            ...
            <Text style={styles.congratsSubText}>
              You have mastered polite English and earned {xp} XP!
            </Text>
            <TouchableOpacity
...
export default beginnerPoliteEnglish;
