...
const _layout = () => {
    return (
        ...
        >
            ...
            />
            <Tabs.Screen
                name="lessonEnglishIntermediate"
                options={{
                    title: "",
                    headerShown: false,
                }}
            />
            <Tabs.Screen
                name="progressEnglishIntermediate"
                options={{
                    title: "",
                    headerShown: false,
                }}
            />
            <Tabs.Screen
                name="leaderboardEnglishIntermediate"
                options={{
                    title: "",
                    headerShown: false,
                }}
            />
            <Tabs.Screen
                name="profileEnglishIntermediate"
                options={{
                    title: "",
                    headerShown: false,
                }}
